...
Bei Temperaturen unter $\SI{500}{\celsius}$ können sich nur die Leerstellen im Kristall bewegen, sodass die Ausrichtung eines Dipols nur durch Leerstellendiffusion geändert werden kann.
...
Nach der Boltzmann-Statistik ist der Anteil ${a \propto \exp(-\frac{W}{kT})}$ aller Dipole in der Lage die Aktivierungsenergie aufgrund ihrer thermischen Anregung aufzubringen.
